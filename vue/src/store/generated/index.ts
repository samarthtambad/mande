...
import MandeLabsMandeMandelabsMandeMande from './mande-labs/mande/mandelabs.mande.mande'
...
export default { 
  ...
  MandeLabsMandeMandelabsMandeMande: load(MandeLabsMandeMandelabsMandeMande, 'mandelabs.mande.mande'),
