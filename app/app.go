...
import (
	...
	"github.com/mande-labs/mande/docs"
...
func New(
	...
	app.MandeKeeper = *mandemodulekeeper.NewKeeper(
		appCodec,
		keys[mandemoduletypes.StoreKey],
		keys[mandemoduletypes.MemStoreKey],
		app.GetSubspace(mandemoduletypes.ModuleName),
	)
